...
``${DESI_ROOT}/survey/catalogs/RELEASE/MOCKS/AbacusSummit/OBSCON/VERSION/altmtlX/fbaX`` contains the fba compiled data of potential and assigned data, matched to the parent forFA file.
